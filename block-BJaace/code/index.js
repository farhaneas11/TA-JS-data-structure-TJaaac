...
delete fourthColor[fourthColor.length];
...
for(let i=0;i<fourthColor.length;i++){  //for(fourth of fourthColor){console.log(fourthColor);}
...
let lastColor=fourthColor.length;
